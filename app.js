...
const balaNave = new proyectil(
	naveInstancia.posX + 22,
	naveInstancia.posY + 20,
	10,
	10,
	'white',
	5
...
const proyectilArriba = function (
	posX,
	posY,
	ancho,
	alto,
...
const balaNaveArriba = new proyectilArriba(
	naveInstancia.posX + 22,
	naveInstancia.posY + 20,
	10,
	10,
...
const balaNaveAbajo = new proyectilAbajo(
	naveInstancia.posX + 22,
	naveInstancia.posY + 20,
	10,
	10,
...
const proyectilEnemigo = function (
	posX,
	posY,
	ancho,
	alto,
...
balasArray.push(
	new proyectilEnemigo(100, random1 + 19, 10, 10, 'white', 0.5)
);
balasArray.push(
	new proyectilEnemigo(100, random2 + 19, 10, 10, 'white', 1)
);
balasArray.push(
	new proyectilEnemigo(100, random3 + 19, 10, 10, 'white', 1.75)
);
balasArray.push(
	new proyectilEnemigo(100, random4 + 19, 10, 10, 'white', 2.25)
);
balasArray.push(
	new proyectilEnemigo(100, random5 + 19, 10, 10, 'white', 1.4)
);
balasArray.push(
	new proyectilEnemigo(100, random6 + 19, 10, 10, 'white', 3.5)
);
balasArray.push(
	new proyectilEnemigo(100, random7 + 19, 10, 10, 'white', 1.75)
);
balasArray.push(
	new proyectilEnemigo(100, random8 + 19, 10, 10, 'white', 0.4)
);
	...
	arrayEnemigos.map((arrayEnemigo) => {
		balasArray.map((balaArray) => {
			...
			arrayBalasNave.map((arrayBalaNave) => {
				if (
					arrayBalaNave.posX + 10 >= arrayEnemigo.posX &&
			...
			if (
				naveInstancia.posX + 50 >= arrayEnemigo.posX &&
			...
			if (
				naveInstancia.posX + 50 >= balaArray.posX &&
...
function principal() {
	...
	for (let i = 0; i < balasArray.length; i++) {
		...
		if (
			naveInstancia.posY >= arrayEnemigos[i].posY - 50 &&
